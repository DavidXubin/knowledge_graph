...
import my_guava.common.base.Preconditions;
import my_guava.common.cache.Cache;
import my_guava.common.cache.CacheBuilder;
import my_guava.common.cache.Weigher;
import my_guava.common.collect.*;
        ...
        public Iterator<JanusGraphElement> getNew(final GraphCentricQuery query) {
            ...
            if (query.getResultType() == ElementCategory.VERTEX && hasModifications()) {
                ...
                if (standardIndexKey == null) {
                    ...
                    vertices = my_guava.common.collect.Iterators.transform(newVertexIndexEntries.get(standardIndexKey.getValue(), standardIndexKey.getKey()).iterator(), new my_guava.common.base.Function<JanusGraphVertexProperty, JanusGraphVertex>() {
                        @Nullable
                        @Override
                ...
                return (Iterator) my_guava.common.collect.Iterators.filter(vertices, query::matches);
