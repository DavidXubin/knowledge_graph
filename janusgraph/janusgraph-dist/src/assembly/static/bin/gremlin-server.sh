...
if [ "$JAVA_OPTIONS" = "" ] ; then
    JAVA_OPTIONS="-Xms2048m -Xmx10360m -javaagent:$JANUSGRAPH_LIB/jamm-0.3.0.jar -Dgremlin.io.kryoShimService=org.janusgraph.hadoop.serialize.JanusGraphKryoShimService"
fi
