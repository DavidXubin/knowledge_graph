...
import my_guava.common.base.Function;
...
public abstract class Mutation<E,K> {
    ...
    /**
     * Checks whether this mutation is consolidated in the sense of {@link #consolidate(my_guava.common.base.Function, my_guava.common.base.Function)}.
